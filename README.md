...
- **/Working_toolchain_NGCD/NGCD_track_1_binary/** -> patched NeoGeo CD binary to substitute to the track 1 plus some other surprises as a patched iso and a binary built from scratch with faster loading time thanks to CD format cleaning compared to the original game.
