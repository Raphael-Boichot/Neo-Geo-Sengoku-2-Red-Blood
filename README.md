...
Dev note: I have no plan to support other ROM formats, MAME romset being the most versatile entry point for other formats. Converters between formats exist but you're on your own to do this on your particular emulator / SD loader / core / FPGA thing. Hack has been validated with a complete walktrough in MAME. You must use MAME in [command line](/Tools/Run_sengoku2.ps1) to force it to run a game not listed in its own database.
