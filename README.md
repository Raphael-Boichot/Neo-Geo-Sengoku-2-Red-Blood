...
My fun hit a wall pretty quickly. The "red blood hack" was never released into the public domain — it was an AES-exclusive version (since the MVS would have been too easy to dump/open), produced in very small quantities and sold at a steep price for just a bootleg. If you want to track one down in 2026, be prepared to dive into the scammer market.
