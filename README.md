...
Summary of CRC32 you should expect before / after patching:
    ...
    File: Sengoku2_Track_01.bin | Original CRC32: 6EFBFA46 | Modified CRC32: 01656B75
...
## Click on image to see bloody action
...
Cherry on top, for all the hacked chunks reinjected, the EDC/ECC 304 bytes are now incorrect (of course). So the last step is to regenerate the EDC/ECC data for each modified chunk with a dedicated tool (included in the workflow). Life is not always a bitch because THERE IS YET A TOOL TO DO THIS!
